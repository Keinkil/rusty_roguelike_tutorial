...
pub fn player_input(gs: &mut State, ctx: &mut Rltk) -> RunState {
    //Player Movement
    match ctx.key {
        None => return RunState::AwaitingInput, // Do nothing
        Some(key) => match key {
            // Cardinal Movement
            ...
            // Diagonal Movement
            VirtualKeyCode::Y | VirtualKeyCode::Numpad9 => try_move_player(1, -1, &mut gs.ecs),
            VirtualKeyCode::U | VirtualKeyCode::Numpad7 => try_move_player(-1, -1, &mut gs.ecs),
